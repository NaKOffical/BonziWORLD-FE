(function() {
    ...
    function renderStartBoard() {
        ...
        document.body.innerHTML = '<div id="start-container" class="start-container"><h1>Solitaire Game - Beta</h1><button id="startnew">PLAY GAME</button><br>' + (getCookie('currentGame') !== null ? '<button id="resume-game" class="resumer">Undo</button>' : '') + '</div>';
    }
    ...
    function clearBoard(cards) {
        ...
        function wipeBoard() {
            if (delay >= (cards - 1)) {
                ...
                document.getElementById("gameboard").innerHTML = '<div class="won"><h1>You are winner of the solitaires.</h1><button id="startnew">PLAY GAME</button></div>';
            } else {
